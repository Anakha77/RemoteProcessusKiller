...
namespace KillerClient.Web_References.KillerService {
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1038.0")]
    [DebuggerStepThrough()]
    [DesignerCategory("code")]
    [WebServiceBinding(Name="BasicHttpBinding_IKillerService", Namespace="http://tempuri.org/")]
    public partial class KillerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [SoapDocumentMethod("http://tempuri.org/IKillerService/GetProcessus", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: XmlArray(IsNullable=true)]
        [return: XmlArrayItem(Namespace="http://schemas.datacontract.org/2004/07/ProcessusKillerService")]
        ...
        /// <remarks/>
        [SoapDocumentMethod("http://tempuri.org/IKillerService/GetProcessusByName", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: XmlArray(IsNullable=true)]
        [return: XmlArrayItem(Namespace="http://schemas.datacontract.org/2004/07/ProcessusKillerService")]
        public ProcessusModel[] GetProcessusByName([XmlElement(IsNullable=true)] string name) {
        ...
        /// <remarks/>
        [SoapDocumentMethod("http://tempuri.org/IKillerService/StopProcessusByName", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void StopProcessusByName([XmlElement(IsNullable=true)] string name, out bool StopProcessusByNameResult, [XmlIgnore()] out bool StopProcessusByNameResultSpecified) {
        ...
        /// <remarks/>
        [SoapDocumentMethod("http://tempuri.org/IKillerService/StopProcessusById", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void StopProcessusById(int id, [XmlIgnore()] bool idSpecified, out bool StopProcessusByIdResult, [XmlIgnore()] out bool StopProcessusByIdResultSpecified) {
    ...
    [DebuggerStepThrough()]
    [DesignerCategory("code")]
    [XmlType(Namespace="http://schemas.datacontract.org/2004/07/ProcessusKillerService")]
